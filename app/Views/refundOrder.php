...
<html lang="en">
                  ...
                  <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end col-sm-6 col-6">
                            <a href="<?= getenv('app.baseURL') ?>home/dashboard" style="color:#ffff; text-decoration:none; font-size: 18px;" ><p><i class="fas fa-arrow-left me-2"></i>Back to dashboard</p></a>
                        </div>
                    </div>
                  </div>
					<?php
                  ...
                  <div class="card-body">
                    <div class="row card-content p-3">
                        <div class="col-md-3 col-sm-3 px-md-2 col-6">
                            <p>Email Id</p>
							<?php
								$params = json_decode(base64_decode($orderDetails['params']),true);
								$billingAddress = $params['billing_address'];
							?>
                            <p><strong><?= $billingAddress['email'] ?></strong></p>
                        </div>
  ...
  <script type="text/javascript" charset="utf8" src="<?= getenv('app.ASSETSPATH') ?>js/toaster/jquery.toaster.js"></script>
	<script type="text/javascript" charset="utf8" src="<?= getenv('app.ASSETSPATH') ?>js/247payuloader.js"></script>
	<script>
