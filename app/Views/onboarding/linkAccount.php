        ...
        <div class="row">
          <div class="col-12 col-md-8 col-lg-6 offset-lg-3 offset-md-2">
            ...
            <div class="login-form pg-30">
              ...
              <form class="form-horizontal" id="linkAccountForm" action="<?= getenv('app.baseURL') ?>onboarding/linkMerchant" method="POST" >
				<input type="hidden" name="mid" value="<?= $data['merchant']['mid'] ?>">
                <button type="submit" class="btn submit-but d-block w-100 btn-lg">Link</button>
