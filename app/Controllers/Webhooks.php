 ...
 * Class Webhooks
 *
 * Represents a PayU webhooks related function to BigCommerce
...
class Webhooks extends BaseController
{
	...
	public function captureFunds($request){
		...
		$paymentURL = getenv('bigcommerceapp.PayU_TEST_URL');
		if(getenv('CI_ENVIRONMENT') == "production"){
			$paymentURL = getenv('bigcommerceapp.PayU_PROD_URL');
		}
